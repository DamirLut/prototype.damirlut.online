...
const imageURL =
  'https://sun2.is74.userapi.com/s/v1/ig2/SM_ySl25_UKHs8EHb-5gy-HN5pRg8IOrWEfnXA6KUH-Q1Z1ZJQTkZxozNQDAJge1o1QFaK15tCw3qOj6KCSDQn3N.jpg?size=200x201&quality=96&crop=135,228,1410,1424&ava=1';
...
const photos = [
  ...
  'https://web.damirlut.online/im-down.webp',
  'https://web.damirlut.online/rgdbar.png',
];
                  ...
                  <Container css={{ p: 0 }} fluid>
                    ...
                    <Row css={{ mt: 10 }}>
                      <Col>
                        <Popover>
                          <Popover.Trigger>
                            <Button iconRight={<EditIcon />} css={{ width: '100%' }}>
                              Написать
                            </Button>
                          </Popover.Trigger>
                          <Popover.Content>
                            <Grid.Container
                              ...
                              <Row justify="center" align="center">
                                <Text b>Вы уверены?</Text>
                              </Row>
                              <Row>
                                <Text>
                                  Чтобы узнать, куда можно обратится, перейдите на страницу{' '}
                                  <Link icon css={{ ml: 5 }} href="contacts">
                                    Связь
                                  </Link>
                                </Text>
                              </Row>
            ...
            <Row css={{ flexDirection: 'column', display: 'inline-flex', gap: '1em' }}>
              <Col>
                <Card
                  ...
                  <div style={{ display: 'inline-flex', gap: '.5em' }}>
                    ...
                    <Text color="primary">13 апреля 2004г ({years} лет).</Text>
                  </div>
                  <Divider css={{ mt: 10, mb: 10 }} />
                  <Row>
                    {stats.map(({ key, value }) => (
              ...
              <Col>
                <Card
                  ...
                  <Card.Header>
                    <Text b>Фотографии</Text>
                  </Card.Header>
                  <Divider />
                  <Card.Body css={{ overflow: 'hidden', maxWidth: '540px' }} ref={scroller}>
                    <Row gap={1}>
                      {photos.map((url) => (
                        <Col key={Math.random()}>
                          <Image
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        if (
                          ...
                          (scroller.current?.scrollWidth || 0) - itemWidth
                        ) {
                          scroller.current?.scrollBy({
                            left: itemWidth,
                            top: 0,
                          ...
                          scroller.current?.scrollTo({ left: 0, top: 0, behavior: 'smooth' });
                        }
                      }}>
                      &gt;
                    </Button>
                        ...
                        <Card bordered>
                          ...
                          <Card.Body>
                            <Grid.Container gap={2}>
                              {languages.map((lang) => (
                                <Grid css={{ width: '100%' }} key={lang.lang}>
                                  {lang.lang}
